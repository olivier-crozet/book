...
$erreur="<p class='codeerreur'>vous n'êtes pas connecté !";
    }
?>
...
<h1 class="titrelogin-index">propositions et discussions sur les problèmes moraux liées aux I.A</h1>
...
<?php
	$bdd = new PDO('mysql:host=127.0.0.1;dbname=olivier-crozet_discussion','olivier-crozet','M3Hfz4H8');
	if (isset($_POST['formconnexion']))
	 { 
		...
		$passwordconexion =sha1($_POST['passwordconect']);
	   	...
	   	{
			$erreur = "<p class=\"er\"><br/>tous les champs doivent être completés !";
			}	
	}
?>
    	<!--fin du php-->  
    	 <table class="inputconexion" >
          ...
          <tr>
              ...
              <td>
                <input type="password" name="passwordconect" placeholder="écrire votre mot de passe">
              </td>
          </tr>    
        </table>
        <br/>
        ...
        <br/><br/>
        		<input class="butonconexion2" type="submit" name="formdeconexion" value="se déconnecté"/>       		   
          </form>
